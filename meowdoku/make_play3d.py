...
<div class="ov" id="ovTut"><div class="sheet">
  ...
  <div class="tut"><div class="n">5</div><div>Every level has exactly one solution. Each one was checked two independent ways (an exhaustive Z3 count and a backtracking count) and comes with a step-by-step derivation from the rulebook; see PACK3D_PROOFS.md in the repository.</div></div>
